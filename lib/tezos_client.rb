...
class TezosClient
  ...
  def prepare_origination_args(args)
    default_args = {
      amount: 0,
      spendable: false,
      delegatable: false,
  ...
  def originate_contract(args)
    origination_args = prepare_origination_args(args)
    ...
    sign_operation(
      ...
      originated_contract = preapply_origination(
        **origination_args,
